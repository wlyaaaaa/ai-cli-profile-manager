...
Describe 'Docs contract' {
    ...
    It 'binds generated handbook PDFs to the current 0.3.8 main documentation' {
        ...
        $builder | Should -Match 'VERSION\s*=\s*"0\.3\.8"'
